...
},
{
  ...
  imageEmoji: "🟠",
  learning: {
    fa: { text: "نارنجی", trans: "nârenji", audioUrl: A("fa", "couleurorange") },
    fr: { text: "orange", audioUrl: A("fr", "couleurorange") },
    en: { text: "orange", audioUrl: A("en", "couleurorange") },
  },
},
{
  id: "noir",
...
// QUESTIONS
  ...
  { id: "1", families: ["chiffres"], imageEmoji: "1", learning: { fa: { text: "یک", trans: "yek", audioUrl: A("fa", "1") }, fr: { text: "un", audioUrl: A("fr", "1") }, en: { text: "one", audioUrl: A("en", "1") }, es: { text: "uno", audioUrl: A("es", "1") } } },
  { id: "2", families: ["chiffres"], imageEmoji: "2", learning: { fa: { text: "دو", trans: "do", audioUrl: A("fa", "2") }, fr: { text: "deux", audioUrl: A("fr", "2") }, en: { text: "two", audioUrl: A("en", "2") }, es: { text: "dos", audioUrl: A("es", "2") } } },
  { id: "3", families: ["chiffres"], imageEmoji: "3", learning: { fa: { text: "سه", trans: "se", audioUrl: A("fa", "3") }, fr: { text: "trois", audioUrl: A("fr", "3") }, en: { text: "three", audioUrl: A("en", "3") }, es: { text: "tres", audioUrl: A("es", "3") } } },
  { id: "4", families: ["chiffres"], imageEmoji: "4", learning: { fa: { text: "چهار", trans: "chahâr", audioUrl: A("fa", "4") }, fr: { text: "quatre", audioUrl: A("fr", "4") }, en: { text: "four", audioUrl: A("en", "4") }, es: { text: "cuatro", audioUrl: A("es", "4") } } },
  { id: "5", families: ["chiffres"], imageEmoji: "5", learning: { fa: { text: "پنج", trans: "panj", audioUrl: A("fa", "5") }, fr: { text: "cinq", audioUrl: A("fr", "5") }, en: { text: "five", audioUrl: A("en", "5") }, es: { text: "cinco", audioUrl: A("es", "5") } } },
  { id: "6", families: ["chiffres"], imageEmoji: "6", learning: { fa: { text: "شش", trans: "shesh", audioUrl: A("fa", "6") }, fr: { text: "six", audioUrl: A("fr", "6") }, en: { text: "six", audioUrl: A("en", "6") }, es: { text: "seis", audioUrl: A("es", "6") } } },
  { id: "7", families: ["chiffres"], imageEmoji: "7", learning: { fa: { text: "هفت", trans: "haft", audioUrl: A("fa", "7") }, fr: { text: "sept", audioUrl: A("fr", "7") }, en: { text: "seven", audioUrl: A("en", "7") }, es: { text: "siete", audioUrl: A("es", "7") } } },
  { id: "8", families: ["chiffres"], imageEmoji: "8", learning: { fa: { text: "هشت", trans: "hasht", audioUrl: A("fa", "8") }, fr: { text: "huit", audioUrl: A("fr", "8") }, en: { text: "eight", audioUrl: A("en", "8") }, es: { text: "ocho", audioUrl: A("es", "8") } } },
  { id: "9", families: ["chiffres"], imageEmoji: "9", learning: { fa: { text: "نه", trans: "noh", audioUrl: A("fa", "9") }, fr: { text: "neuf", audioUrl: A("fr", "9") }, en: { text: "nine", audioUrl: A("en", "9") }, es: { text: "nueve", audioUrl: A("es", "9") } } },
  { id: "10", families: ["dizaines"], imageEmoji: "10", learning: { fa: { text: "ده", trans: "dah", audioUrl: A("fa", "10") }, fr: { text: "dix", audioUrl: A("fr", "10") }, en: { text: "ten", audioUrl: A("en", "10") }, es: { text: "diez", audioUrl: A("es", "10") } } },
  ...
  { id: "20", families: ["dizaines"], imageEmoji: "20", learning: { fa: { text: "بیست", trans: "BIST", audioUrl: A("fa", "20") }, fr: { text: "vingt", audioUrl: A("fr", "20") }, en: { text: "twenty", audioUrl: A("en", "20") }, es: { text: "veinte", audioUrl: A("es", "20") } } },

  { id: "30", families: ["dizaines"], imageEmoji: "30", learning: { fa: { text: "سی", trans: "si", audioUrl: A("fa", "30") }, fr: { text: "trente", audioUrl: A("fr", "30") }, en: { text: "thirty", audioUrl: A("en", "30") }, es: { text: "treinta", audioUrl: A("es", "30") } } },
  { id: "40", families: ["dizaines"], imageEmoji: "40", learning: { fa: { text: "چهل", trans: "chehel", audioUrl: A("fa", "40") }, fr: { text: "quarante", audioUrl: A("fr", "40") }, en: { text: "forty", audioUrl: A("en", "40") }, es: { text: "cuarenta", audioUrl: A("es", "40") } } },
  { id: "50", families: ["dizaines"], imageEmoji: "50", learning: { fa: { text: "پنجاه", trans: "panjâh", audioUrl: A("fa", "50") }, fr: { text: "cinquante", audioUrl: A("fr", "50") }, en: { text: "fifty", audioUrl: A("en", "50") }, es: { text: "cincuenta", audioUrl: A("es", "50") } } },
  { id: "60", families: ["dizaines"], imageEmoji: "60", learning: { fa: { text: "شصت", trans: "shast", audioUrl: A("fa", "60") }, fr: { text: "soixante", audioUrl: A("fr", "60") }, en: { text: "sixty", audioUrl: A("en", "60") }, es: { text: "sesenta", audioUrl: A("es", "60") } } },
  { id: "70", families: ["dizaines"], imageEmoji: "70", learning: { fa: { text: "هفتاد", trans: "haftâd", audioUrl: A("fa", "70") }, fr: { text: "soixante-dix", audioUrl: A("fr", "70") }, en: { text: "seventy", audioUrl: A("en", "70") }, es: { text: "setenta", audioUrl: A("es", "70") } } },
  { id: "80", families: ["dizaines"], imageEmoji: "80", learning: { fa: { text: "هشتاد", trans: "hashtâd", audioUrl: A("fa", "80") }, fr: { text: "quatre-vingts", audioUrl: A("fr", "80") }, en: { text: "eighty", audioUrl: A("en", "80") }, es: { text: "ochenta", audioUrl: A("es", "80") } } },
  { id: "90", families: ["dizaines"], imageEmoji: "90", learning: { fa: { text: "نود", trans: "navad", audioUrl: A("fa", "90") }, fr: { text: "quatre-vingt-dix", audioUrl: A("fr", "90") }, en: { text: "ninety", audioUrl: A("en", "90") }, es: { text: "noventa", audioUrl: A("es", "90") } } },
